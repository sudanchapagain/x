...
<head>
    ...
    <link rel="stylesheet" href="../assets/stylesheet/course.css">
...
<body>
    <div class="page">
        ...
        <h1>Bachelor Programs</h1>
        <br>
        <p>RR Campus has undergraduate courses on the following topics: </p>

        <div class="container">
            <div class="courseBox">Sociology</div>
            <div class="courseBox">Geology</div>
            <div class="courseBox">Rural Development</div>
            <div class="courseBox">Music</div>
            <div class="courseBox">Computer Application</div>
            <div class="courseBox">Anthropology</div>
        </div>
