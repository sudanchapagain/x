...
<body>
    <div class="page">
        ...
        <form method="POST" action="../scripts/create_process.php">
            <div class="grid">
                <div>
                    <p class="formTitle">Full Name</p>
                    <input type="text" name="name" placeholder="Your Name" size="40" class="simple" required>
                    <br><br>

                    <p class="formTitle">Email</p>
                    <input type="email" size="40" placeholder="yourname@site.com" name="email" class="simple" required><br><br>
                </div>


                <div>
                    <p class="formTitle">Contact Number </p>
                    <input type="tel" size="40" placeholder="+977 98*******" name="number" class="simple" required>
                    <br><br>

                    <p class="formTitle">Password:</p>
                    <input type="password" size="40" placeholder="********" name="password" class="simple" required>
                </div>
            </div>
            <br>
            <br>
