...
- lambdas
- extension functions
- list, set, map, filter, Map, existential,find, firstlast, count, associateBy
- partition, flatmap, max, sorted, Map getvalue, zip, getorelse
- let, run, with, apply, also
- delegation pattern, delegated properties
- named args, string templates, destructuing declarations, smart casts
- kotlin js - dynamic, js func, external, canvas, htmlbuilder
- leetcode/neetcode
*/
...
// <https://www.reddit.com/r/JetpackComposeDev/comments/1mogs4o/most_common_android_architecture_interview/>
