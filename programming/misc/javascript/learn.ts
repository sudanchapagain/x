...
let isDone0: boolean = false;
let lines0: number = 42;
let name0: string = "Sudan";
...
let validPerson: Person = { name1: "Bobby", age: 42, move: () => { } };
// Is not a person because age is not a number
let invalidPerson: Person = { name1: "Bobby", age: true };
