// Jsonnet is a powerful templating language for JSON. Any valid JSON document
// is a valid Jsonnet object.
...
Passing variables from command line: <https://jsonnet.org/learning/tutorial.html#parameterize-entire-config>
Import other jsonnet libraries/files: <https://jsonnet.org/learning/tutorial.html#imports>
In depth example of OOP aspect of Jsonnet: <https://jsonnet.org/learning/tutorial.html#Object-Orientation>
Useful standard library: <https://jsonnet.org/ref/stdlib.html>
