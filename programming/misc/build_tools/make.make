# A Makefile defines a graph of rules for creating a target (or targets). Its
# purpose is to do the minimum amount of work needed to update a target to
# the most recent version of the source. Famously written over a weekend by
# Stuart Feldman in 1976, it is still widely used (particularly on Unix and
# Linux) despite many competitors and criticisms.
