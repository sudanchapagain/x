...
class SchemeModule {
    ...
    static async fetch_and_instantiate(path_or_data, { abi, reflect_wasm_dir = '.',
                                               user_imports = {} }) {
        ...
        var mod = null;
        let { module, instance } = await instantiate(path_or_data, imports);
        mod = new SchemeModule(instance);
        return mod;
    }
