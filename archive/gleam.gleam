// Gleam is a ML-inspired language that has C-like syntax that runs on the BEAM
// virtual machine, with the added ability to compile to JavaScript.

// Gleam does not aim to fully replicate or integrate all of the foundational
// features of Erlang's runtime, particularly OTP (Open Telecom Platform). OTP is
// a set of libraries and principles that provide a framework for building
// fault-tolerant, distributed systems.

// It aims for compatibility with both BEAM and JavaScript. As a result, certain
// BEAM-specific features are not as deeply supported in Gleam compared to others.
